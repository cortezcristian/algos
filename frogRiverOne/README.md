...
The frog can cross the river then there is a FULL sequence of numbers from 1 to X.
Lets say X = 5. Array is {1,1,2,3,5,6,4}
She will cross the river only at step 7 because only then a full sequence to 5 (12345) will appear
